...
function Generate-Certificate {
    ...
    if (!$ADCSWebEnrollmentUrl -and !$CSRGenOnly) {
        ...
        $IssuingCertAuth = "cb-ca.cb.corp\CB-CA"
    ...
    if (Test-Path "$CertGenWorking\$CertFileOut") {
        ...
        if ($MachineKeySet -eq "FALSE") {
            if ($ThumprintToAvoid) {
                $LocationOfCertInStore = $(Get-ChildItem Cert:\CurrentUser\My | Where-Object {$_.Subject -match "$CertificateCN," -and $_.Thumbprint -notmatch $ThumprintToAvoid}) | Select-Object -ExpandProperty PSPath
            }
            else {
                $LocationOfCertInStore = $(Get-ChildItem Cert:\CurrentUser\My | Where-Object {$_.Subject -match "$CertificateCN,"}) | Select-Object -ExpandProperty PSPath
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNCIWha4WfpVwdQYuNezHoRdd
# F2ugggndMIIEJjCCAw6gAwIBAgITawAAADqEP46TDmc/hQAAAAAAOjANBgkqhkiG
...
# BDEWBBQLzL3DAIjExLin3rAiPK/w0uKU0TANBgkqhkiG9w0BAQEFAASCAQBzU87g
# Abk7phO9RblJAgHQKD7OzkRw8xHFv8USyehIy6uhgmHujQQcj9WFphWiD0L3Ytgc
# EThSks6Qb1nCTN047oBr5aQ0bZQt6Jip4IcnzLhzBHb9WBPt0wGsJA0S61rdo2mA
# TdGlyavg8jSNFNiqzGNSNUfloPrHH9Ok7SyvIPbgauG14V97ouIoDfPZVmUs/Bj6
# 610Vzq0fZ+fyAdPF7ywfKtVxnZsBuT5FHHojQWNaHISyBRugewnBJtp6CV6mQ583
# GlUyi7GxSFo1TIT+/MyaJIN2kynCx/Sc97/11G/VIOa8Lwjiupf/DAj1E/dmdTTZ
# f4sNOYdy60mK1MBZ
